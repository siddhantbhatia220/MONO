...
const TYPE_KEYWORDS: Record<ItemType, string[]> = {
  [ItemType.Task]: ['do', 'fix', 'build', 'create', 'write', 'send', 'buy', 'clean', 'finish', 'submit', 'refactor', 'deploy'],
  [ItemType.Note]: ['note', 'idea', 'thought', 'summary', 'memo', 'outline', 'draft', 'brainstorm'],
  [ItemType.Goal]: ['goal', 'target', 'milestone', 'achieve', 'reach', 'quarterly', 'annual', 'objective'],
  [ItemType.Event]: ['meet', 'meeting', 'call', 'sync', 'zoom', 'conference', 'interview', 'webinar', 'appointment', 'calendar'],
  [ItemType.Habit]: ['daily', 'everyday', 'habit', 'streak', 'workout', 'meditate', 'read daily', 'water', 'exercise'],
  [ItemType.Bookmark]: ['http', 'https', 'link', 'article', 'read later', 'bookmark', 'url', 'site'],
  [ItemType.Checklist]: ['list', 'checklist', 'packing', 'todos', 'items'],
}

const PRIORITY_KEYWORDS: Record<Priority, string[]> = {
  [Priority.Critical]: ['asap', 'critical', 'emergency', 'blocker', 'down', 'fire', 'urgent!!', 'immediately'],
...
const TAG_KEYWORDS: Record<string, string[]> = {
  work: ['work', 'client', 'project', 'client', 'boss', 'meeting', 'report', 'code', 'pr', 'feature', 'bug'],
